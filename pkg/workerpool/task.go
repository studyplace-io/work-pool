...
type TaskInstance struct {
	...
	f    func(interface{}) (interface{}, error) // 处理函数
}

// NewTaskInstance 建立任务
func NewTaskInstance(name string, data interface{}, f func(interface{}) (interface{}, error)) *TaskInstance {
	return &TaskInstance{
		Name: name,
		Data: data,
		f:    f,
...
func (t *TaskInstance) Execute() (interface{}, error) {
	result, err := t.f(t.Data) // 执行任务。如果任务执行错误，赋值err
	if err != nil {
		t.Err = err
		return nil, err
	}
